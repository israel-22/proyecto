        ...
        <View>
          ...
          <Body2>
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/nasa.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>La NASA busca Ingenieros Matematios y Quimicos Con Visa a EEUU </Text>
              </View>
            ...
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/entrega.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Grupo Entrega busca Chofetes Profecionales Tipo E en Cuenca</Text>
              </View>
              <View style={style.btn}>
                <ButtonComponent title='postular' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenMenu'}))}/>
              </View>
            ...
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/venus.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Zapatos Venus busca Vendedores en Valle de los Chillos</Text>
              </View>
              <View style={style.btn}>
                <ButtonComponent title='postular' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenMenu'}))}/>
              </View>
            ...
            <ButtonComponent title='Siguiente' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenPostular2'}))}/>
            </View>
