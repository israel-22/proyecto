        ...
        <View>
          ...
          <Body2>
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/correoEcuador.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Correros del Ecuador busca Analista de Datos en Orellana</Text>
              </View>
            ...
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/microsoft.webp')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Microsoft busca Desarrolladores de Software en Manabi</Text>
              </View>
              <View style={style.btn}>
                <ButtonComponent title='postular' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenMenu'}))}/>
              </View>
            ...
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/huawei.webp')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Huawei busca Vendedores en el centro de Cotopaxi</Text>
              </View>
              <View style={style.btn}>
                <ButtonComponent title='postular' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenMenu'}))}/>
              </View>
