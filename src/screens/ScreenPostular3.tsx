        ...
        <View>
          ...
          <Body2>
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/CNT_Logo.svg.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>CNT busca Tecnicos en Redes en el centro de Loja</Text>
              </View>
            ...
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/universal.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>La universal Busca Chef de Reposteria para elaboracion de chocolates en Santo Domingo</Text>
              </View>
              <View style={style.btn}>
                <ButtonComponent title='postular' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenMenu'}))}/>
              </View>
            ...
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/pepsi.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Pepsi busca Auxiliares de Bodega en Tumbaco norte de Quito</Text>
              </View>
              <View style={style.btn}>
                <ButtonComponent title='postular' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenMenu'}))}/>
              </View>
            ...
            <ButtonComponent title='Siguiente' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenPostular4'}))}/>
            </View>
