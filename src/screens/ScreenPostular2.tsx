        ...
        <View>
          ...
          <Body2>
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/deprati.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Almacenes Deprati busca Gerente  para Quisentro Shopyng</Text>
              </View>
            ...
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/banner.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Pintulac busca Axiliares de Bodega en Quininde</Text>
              </View>
              <View style={style.btn}>
                <ButtonComponent title='postular' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenMenu'}))}/>
              </View>
            ...
            <View style={[style.container, style.marginBottom]}>
              <Image style={style.imagen}  source={require('../img/tia.png')}  /> 
              <View style={style.textConatiner}>
                <Text style={style.txt}>Supermercados Tia Busca cajera en Latacunga</Text>
              </View>
              <View style={style.btn}>
                <ButtonComponent title='postular' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenMenu'}))}/>
              </View>
            ...
            <ButtonComponent title='Siguiente' onPress={()=>navigation.dispatch(CommonActions.navigate({name:'ScreenPostular3'}))}/>
            </View>
